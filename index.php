    ...
    <div class="login-box">
        <div class="login-logo">
            ...
            if (mysqli_num_rows($call) == 0) {
                ...
                while ($row = mysqli_fetch_assoc($call)) {
                    $_SESSION['systemId']=$row['sysid'];
                    ?>
                    <a href="index.php"> <img src="img/<?php echo $row ['image']; ?>"
                                              alt="User Image"></a>
                    <a href="index.php"><h3 style="color: darkorange;"><strong><?php echo $row ['name']; ?></strong>
                        </h3></a>
                <?php }
            } ?>
        </div>
            ...
            <form class="form" method="post" enctype="multipart/form-data">
                ...
                <div align="right">
                    <a href="forgetpassword.php">
                        <button type="button" class="btn btn-warning btn-flat"><i class="fa fa-mail-reply-all"></i>&nbsp;Forget
                            Password&nbsp;?
                        </button>
                    </a>
                    <button name="submit" type="submit" class="btn btn-success btn-flat"><i class="fa fa-send"></i>&nbsp;Sign
                        In
                    </button>
                </div>
...
//$sql = mysqli_query($link,"UPDATE user SET Signal='On' WHERE Email = '$email'") or die(mysqli_error($link));
    ...
    <script type="text/javascript">
        ...
        (function () {
            ...
            s1.async = true;
            s1.src = 'https://embed.tawk.to/5ef0b39a9e5f6944229112c5/default';
            s1.charset = 'UTF-8';
