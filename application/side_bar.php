<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="dashboard.php?id=<?php echo $_SESSION['tid']; ?>"><i class="fa fa-dashboard"></i> <span>Dashbord</span></a>
            </li>
            ...
            <li class="treeview">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                ...
                <ul class="treeview-menu">
                    <li class="active"><a href="newborrowers.php?id=<?php echo $_SESSION['tid']; ?>"><i
                                    class="fa fa-circle-o"></i> New Borrowers</a></li>
              ...
              <i class="fa fa-angle-left pull-right"></i>
                ...
                <ul class="treeview-menu">
                    ...
                    <li><a href="listpayment.php?id=<?php echo $_SESSION['tid']; ?>"><i class="fa fa-circle-o"></i>List
                            Payments</a></li>
                    <li><a href="missedpayment.php?id=<?php echo $_SESSION['tid']; ?>"><i class="fa fa-dollar"></i>
                            <span>Missed Payment</span></a></li>
                </ul>
            </li>
            <li><a href="mywallet.php?id=<?php echo $_SESSION['tid']; ?>"><i class="fa fa-book"></i>
            ...
            <li class="treeview">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                ...
                <ul class="treeview-menu">
                    <li><a href="emp_role.php?id=<?php echo $_SESSION['tid']; ?>"><i class="fa fa-circle-o"></i>Employee
                            Role</a></li>
                    <li><a href="permission_list.php?id=<?php echo $_SESSION['tid']; ?>"><i class="fa fa-circle-o"></i>Permission
                            List</a></li>
                    <li><a href="add_permission.php?id=<?php echo $_SESSION['tid']; ?>"><i class="fa fa-circle-o"></i>Add
                            Permission</a></li>
                </ul>
            </li>

            <li><a href="savings.php?id=<?php echo $_SESSION['tid']; ?>"><i class="fa fa-money"></i> <span>Savings Account</span></a>
            </li>
            ...
            <li class="treeview">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                ...
                <ul class="treeview-menu">
                    <li><a href="system_set.php?id=<?php echo $_SESSION['tid']; ?>"><i class="fa fa-circle-o"></i>System
                            Configuration</a></li>
                    <li><a href="sms.php?id=<?php echo $_SESSION['tid']; ?>"><i class="fa fa-circle-o"></i>SMS Gateway
                            Settings</a></li>
                    <li><a href="backupdatabase.php?id=<?php echo $_SESSION['tid']; ?>"><i class="fa fa-circle-o"></i>Backup
                            Database</a></li>
                </ul>
            </li>
