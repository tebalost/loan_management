...
<?php
$tid = $_SESSION['tid'];
$select = mysqli_query($link, "SELECT * FROM sms_messages") or die (mysqli_error($link)); //FIXME, Date Range for the months for now get all and add the filter to coose the date range
