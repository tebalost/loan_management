                ...
                while ($sel = mysqli_fetch_array($se)) {
                    ...
                    <form action="edit_api.php" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="inputName" value="<?php echo $api_name; ?>"
                                       name="title" readonly>
                            </div>
                        </div>
                        <hr>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="inputName" placeholder="Enter your Username"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="inputName" placeholder="Enter your password"
                                       value="<?php echo $password; ?>" name="password" required>
                            </div>
                        </div>
                        <hr>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="inputName" value="<?php echo $api; ?>"
                                       name="api" readonly>
                            </div>
                        </div>
                        <hr>
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-2 col-sm-10">
                                <br>
                                <button type="submit" name="submit" class="btn btn-success"><i class="fa fa-save"></i>&nbsp;Update
                                    Settings
                                </button>
                                <br><br>
                            </div>
