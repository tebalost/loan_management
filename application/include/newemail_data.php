...
//send email
    ...
    {
        $insert = mysqli_query($link, "INSERT INTO etemplates VALUES(0,'$tid','$email','$subj','$msg',NOW())") or die (mysqli_error($link));
        echo "<hr>";
             ...
             <div class="box-body">
			  ...
			  <a href = "#" class = "close" data-dismiss= "alert"> &times;</a>
				...
				<div class="form-group">
                  <label for="" class="col-sm-2 control-label" >Select Receiver</label>
                  <div class="col-sm-10">
