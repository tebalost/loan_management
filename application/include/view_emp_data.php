        ...
        <div class="panel panel-success">
            ...
            <div class="box-body">
                ...
                if (count($_POST) > 0) {
                    ...
                    $update = mysqli_query($link, "UPDATE user set name='" . $_POST['name'] . "', email='" . $_POST['email'] . "' , gender='" . $_POST['gender'] . "',
								phone='" . $_POST['phone'] . "', password='$password', addr1='" . $_POST['addr1'] . "',  image='" . $location . "'  , comment='" . $_POST['comment'] . "' , id_number='" . $_POST['id_number'] . "',
								username='" . $_POST['username'] . "' WHERE userid='" . $_POST['userid'] . "'")
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <img id="blah" class="img-circle" src="../<?php echo $rows['image']; ?>"
                                         alt="Image Here" height="120" width="120"/>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <select name="gender" class="form-control" required>
                                        ...
                                        <option <?php if ($rows['gender'] == "Male") {
                                            echo "selected";
                                        } ?>>Male
                                        </option>
                                        <option <?php if ($rows['gender'] == "Female") {
                                            echo "selected";
                                        } ?>>Female
                                        </option>
                                    </select>
                            ...
                            <div class="form-group">
                                <label for="" class="col-sm-2 control-label">ID Mumber</label>
                                <div class="col-sm-10">
                                    <input name="id_number" type="text" class="form-control"
                                           value="<?php echo $rows['id_number']; ?>" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="addr1" class="form-control" rows="2" cols="80"
                                              required><?php echo $rows['addr1']; ?></textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="addr2" class="form-control" rows="2" cols="80"
                                              required><?php echo $rows['addr2']; ?></textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="comment" class="form-control" rows="2" cols="80"
                                              readonly><?php echo $rows['comment']; ?></textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input name="username" type="text" class="form-control"
                                           value="<?php echo $rows['username']; ?>" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input name="password" type="password" class="form-control"
                                           value="<?php echo base64_decode($rows['password']); ?>" required>
                                </div>
                            </div>
