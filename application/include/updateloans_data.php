                                            ...
                                            <form class="form-horizontal" method="post" enctype="multipart/form-data"
                                                ...
                                                <div class="box-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input name="account" type="text" class="form-control"
                                                                   value="<?php echo $row['baccount']; ?>" readonly>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="col-sm-10">
                                                            <div class="input-group date">
                                                                ...
                                                                <input name="date_release" type="text"
                                                                       ...
                                                                       value="<?php echo $row['date_release']; ?>"
                                                                       readonly>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input name="agent" type="text" class="form-control"
                                                                   value="<?php echo $row['agent']; ?>" readonly>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <textarea name="remarks" class="form-control" rows="4"
                                                                      cols="80"
                                                                      readonly="readonly"><?php echo $row['remarks']; ?></textarea>
                                                        </div>
                                                    </div>


                                                    <hr>
                                                    <div class="panel-body bg-gray text-bold">&nbsp;GUARANTOR INFORMATION</div>
                                                    <hr>

                                                    <div class="form-group">
                                                        <label for="" class="col-sm-2 control-label"
                                                              >Gurantor's Passport</label>
                                                        <div class="col-sm-10">

                                                            <img id="blah" src="../<?php echo $row ['g_image']; ?>"
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input name="agent" type="text" class="form-control"
                                                                   value="<?php echo $row['g_name']; ?>" readonly>
                                                        </div>
                                                    </div>

                                                    <div class="form-group">
                                                        <label for="" class="col-sm-2 control-label"
                                                              >Guarantor's Phone Number</label>
                                                        <div class="col-sm-10">
                                                            <input name="agent" type="text" class="form-control"
                                                                   value="<?php echo $row['g_phone']; ?>" readonly>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <textarea name="gaddress" class="form-control" rows="4"
                                                                      cols="80"
                                                                      readonly="readonly"><?php echo $row['g_address']; ?></textarea>
                                                        </div>
                                                    </div>


                                                    <hr>
                                                    <div class="panel-body bg-gray text-bold">&nbsp;PAYMENT INFORMATION</div>
                                                    <hr>
                                                        ...
                                                        <div class="col-sm-10">
                                                            <div class="input-group date">
                                                                ...
                                                                <input name="pay_date" type="text"
                                                                       class="form-control pull-right"
                                                                       value="<?php echo $row['pay_date']; ?>" readonly>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        <label for="" class="col-sm-2 control-label"
                                                              >Amount to Pay</label>
                                                        <div class="col-sm-10">
                                                            <input name="amount_topay" type="number"
                                                                   class="form-control"
                                                                   value="<?php echo $row['amount_topay']; ?>" readonly>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input name="teller" type="text" class="form-control"
                                                                   value="<?php echo $row['teller']; ?>" readonly>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="tab-pane active" id="tab_2">
                                        <form method="post">
                                                ...
                                                while ($have = mysqli_fetch_array($search)) {
                                                    ...
                                                    <tr>
                                                        <td width="30"><input id="optionsCheckbox" class="uniform_on"
                                                                              ...
                                                                              value="<?php echo $idme; ?>" checked></td>
                                                        <td width="800"><input name="fee[]" type="text"
                                                                               class="form-control" placeholder="Fee"
                                                                               value="<?php echo $have['fee']; ?>"></td>
                                                        <td width="300"><input name="amount[]" type="number"
                                                                               class="form-control" placeholder="Amount"
                                                                               value="<?php echo $have['Amount']; ?>">
                                                        </td>
                                                    </tr>
                                                <?php } ?>
                                                </tbody>
                                            ...
                                            <div align="left">
                                                <div class="box-footer">
                                                    <button type="submit" class="btn btn-success btn-flat"
                                                            name="add_fees_rows"><i class="fa fa-plus">&nbsp;Add Row</i>
                                                    </button>
                                                    <button name="delrow" type="submit" class="btn btn-danger btn-flat">
                                                        <i class="fa fa-trash">&nbsp;Delete Row</i></button>
                                            ...
                                            if (isset($_POST['add_fees_rows'])) {
                                                $id = $_GET['id'];
                                                $tid = $_SESSION['tid'];
                                                $insert = mysqli_query($link, "INSERT INTO additional_fees(id,get_id,tid,fee,Amount) VALUES(0,'$id','$tid','','')") or die (mysqli_error($link));
                                                if (!$insert) {
                                            ...
                                            <div align="right">
                                                <div class="box-footer">
                                                    <button type="submit" class="btn btn-info btn-flat" name="add_fees">
                                                        <i class="fa fa-save">&nbsp;Update Additional Fees</i></button>
                                                ...
                                                if ((!empty($_FILES["uploaded_file"])) && ($_FILES['uploaded_file']['error'] == 0)) {
                                                    ...
                                                    if (($ext != "exe") && ($_FILES["uploaded_file"]["type"] != "application/x-msdownload")) {
                                                        ...
                                                        if ((move_uploaded_file($_FILES['uploaded_file']['tmp_name'], $newname))) {
                                                            ...
                                                            $insert = mysqli_query($link, "INSERT INTO attachment(id,get_id,tid,attached_file,date_time) VALUES(0,'$id','$tid','$newname',NOW())") or die (mysqli_error($link));
                                                            if (!$insert) {
                                                                echo "<script>alert('Record not inserted.....Please try again later!'); </script>";
                                                            } else {
...
//upload random name/number
                                            ...
                                            if ((!empty($_FILES["uploaded_file"])) && ($_FILES['uploaded_file']['error'] == 0)) {
                                                ...
                                                if (($ext != "exe") && ($_FILES["uploaded_file"]["type"] != "application/x-msdownload")) {
                                                    ...
                                                    if ((move_uploaded_file($_FILES['uploaded_file']['tmp_name'], $newname))) {
                                                        ...
                                                        $insert = mysqli_query($link, "INSERT INTO collateral VALUES(0,'$id','$tid','$name','$type_of_collateral','$model','$make','$serial_number','$estimated_price','$filename','$cimage','$observation')") or die (mysqli_error($link));
                                                        if (!$insert) {
                                                            echo "<script>alert('Record not inserted.....Please try again later!'); </script>";
                                                        } else {
                                        ...
                                        if (mysqli_num_rows($search) == 1) {
                                            ...
                                            <form class="form-horizontal" method="post" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group">
                                                    <label for="" class="col-sm-2 control-label">Type
                                                        of Collateral:</label>
                                                    <div class="col-sm-10">
                                                ...
                                                <div class="form-group">
                                                    <label for="" class="col-sm-2 control-label">Serial
                                                        Number:</label>
                                                    <div class="col-sm-10">
                                                ...
                                                <div class="form-group">
                                                    <label for="" class="col-sm-2 control-label">Estimated
                                                        Price:</label>
                                                    <div class="col-sm-10">
                                                ...
                                                <div class="form-group">
                                                    <label for="" class="col-sm-2 control-label">Proof of Ownership:</label>
                                                    <div class="col-sm-10">
                                                        Accepted file types <span style="color:#FF0000">jpg, gif, png, xls, xlsx, csv, doc, docx, pdf</span>
                                                        <input name="uploaded_file" type="file" class="btn btn-info">
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    <label for="" class="col-sm-2 control-label">Observations:</label>
                                                    <div class="col-sm-10">
                                                ...
                                                <div align="center">
                                                    <div class="box-footer">
                                                        <button type="submit" class="btn btn-success btn-flat"
                                                                name="submit"><i class="fa fa-save">&nbsp;Submit</i>
                                                        </button>
                                                    </div>
                                                </div>
                                            </form>
                                            ...
                                            <form class="form-horizontal" method="post" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group">
                                                    <label for="" class="col-sm-2 control-label">Proof
                                                        of Ownership:</label>
                                                    <div class="col-sm-10">
                                                        Accepted file types <span style="color:#FF0000">jpg, gif, png, xls, xlsx, csv, doc, docx, pdf</span>
                                                        <input name="uploaded_file" type="file" class="btn btn-info">
                                    ...
                                    <div class="tab-pane" id="tab_5">
                                        <form class="form-horizontal" method="post" enctype="multipart/form-data">
                                            <div class="box-body">
                                                ...
                                                <div class="form-group">
                                                    <label for="" class="col-sm-2 control-label">Schedule
                                                        of Payment:</label>
                                                    <div class="col-sm-10">
                                                ...
                                                <div class="form-group">
                                                    <label for="" class="col-sm-2 control-label">Interest
                                                        Rate:</label>
                                                    <div class="col-sm-10">
                                                ...
                                                <div class="form-group">
                                                    <label for="" class="col-sm-2 control-label">Penalty:</label>
                                                    <div class="col-sm-10">
                                                ...
                                                <div class="form-group">
                                                    <label for="" class="col-sm-2 control-label">Schedules:</label>
                                                    <div class="col-sm-10">
                                                        <table>
                                                            <tbody>
                                                            <?php
                                                            ...
                                                            while ($haveit = mysqli_fetch_array($searchin)) {
                                                                ...
                                                                <tr>
                                                                    <td width="30"><input id="optionsCheckbox"
                                                                                          ...
                                                                                          name="selector[]"
                                                                                          type="checkbox"
                                                                                          value="<?php echo $idmet; ?>"
                                                                                          checked></td>
                                                                    <td width="400"><input name="schedulek[]"
                                                                                           type="text"
                                                                                           class="form-control pull-right"
                                                                                           id="datepicker"
                                                                                           placeholder="Schedule"
                                                                                           value="<?php echo $haveit['schedule']; ?>">
                                                                    </td>
                                                                    <td width="300"><input name="balance[]"
                                                                                           type="number"
                                                                                           class="form-control"
                                                                                           placeholder="Balance"
                                                                                           value="<?php echo $haveit['balance']; ?>">
                                                                    </td>
                                                                    <td width="200"><input name="interest[]"
                                                                                           type="number"
                                                                                           class="form-control"
                                                                                           placeholder="Interest"
                                                                                           value="<?php echo $haveit['interest']; ?>">
                                                                    </td>
                                                                    <td width="100"><input name="payment[]"
                                                                                           type="number"
                                                                                           class="form-control"
                                                                                           placeholder="Payment"
                                                                                           value="<?php echo $haveit['payment']; ?>">
                                                                    </td>
                                                                </tr>
                                                            <?php } ?>
                                                            </tbody>
                                                        ...
                                                        <div align="left">
                                                            <div class="box-footer">
                                                                <button type="submit" class="btn btn-success btn-flat"
                                                                        name="add_sch_rows"><i class="fa fa-plus">&nbsp;Add
                                                                        Row</i></button>
                                                                <button name="delrow2" type="submit"
                                                                        class="btn btn-danger btn-flat"><i
                                                                            class="fa fa-trash">&nbsp;Delete Row</i>
                                                                </button>
                                                        ...
                                                        if (isset($_POST['add_sch_rows'])) {
                                                            $id = $_GET['id'];
                                                            $tid = $_SESSION['tid'];
                                                            $insert = mysqli_query($link, "INSERT INTO pay_schedule(id,get_id,tid,schedule,balance,interest,payment) VALUES(0,'$id','$tid','','','','')") or die (mysqli_error($link));
                                                            if (!$insert) {
                                            ...
                                            <div align="right">
                                                <div class="box-footer">
                                                    <button type="submit" class="btn btn-info btn-flat"
                                                            name="add_pay_schedule"><i class="fa fa-save">&nbsp;Update Payment Schedule</i></button>
                                            ...
                                            if (isset($_POST['add_pay_schedule'])) {
                                                ...
                                                if ($N == 0) {
                                                    ...
                                                    foreach ($_POST['selector'] as $s) {
                                                        ...
                                                        $insert = mysqli_query($link, "INSERT INTO payment_schedule VALUES('0','$s','$tid','$term','$day','$schedule_of_paymt','$interest','$penalty')") or die (mysqli_error($link));
                                                        $insert = mysqli_query($link, "UPDATE loan_info SET upstatus = 'Completed', modified_date='$loan_update', modified_by='$tid' WHERE id = '$idm'") or die (mysqli_error($link));
                                                        if (!($update && $insert)) {
                                                            echo "<script>alert('Record not inserted.....Please try again later!'); </script>";
                                                        } else {
