...
class HttpStatusCode{
    ...
    public static function setHttpHeaders($statusCode){
        $statusMessage = HttpStatusCode::getHttpStatusMessage($statusCode);
        header(HttpStatusCode::$httpVersion. " ". $statusCode ." ". $statusMessage);
        header("Content-Type:". HttpStatusCode::$contentType);
    }
