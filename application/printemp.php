  ...
  <section class="invoice">
    ...
    <div class="row">
      <div class="col-xs-12">
		...
		{
?>
           <div><div style="font-size:15px"><div align="center"><?php echo '&nbsp;&nbsp;&nbsp;'. $row ['name'];?></div></div></div>
		   <small class="pull-left"><div><Strong>All list Employee details</Strong></div></small>
          <small class="pull-right"><div><?php $today = date ('y:m:d');
