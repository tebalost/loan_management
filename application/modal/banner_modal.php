        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <hr>
                    <button type="button" class="btn btn-danger btn-outline btn-flat" data-dismiss="modal"><i
                                class="fa fa-minus"></i>&nbsp;Close
                    </button>
                </div>
            </div>
                ...
                <div class="table-responsive">
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            <label for="" class="col-sm-2 control-label" align="center">Browse Image <span
                                        style="color:#FF0000">png format only</span></label>
                            <div class="col-sm-10">
                        ...
                        <hr>
                        <button type="submit" class="btn btn-success btn-flat" name="upload"><i class="fa fa-upload">Upload</i>
                        </button>
                        <button type="button" class="btn btn-danger btn-outline btn-flat" data-dismiss="modal"><i
                                    class="fa fa-minus"></i>&nbsp;No
                        </button>
