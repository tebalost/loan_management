        ...
        <div class="modal-dialog" id="printableArea">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <legend style="color: red;"><?php echo ($row['t_type'] == "Withdraw") ? 'Withdrawal' : 'Deposit'; ?>
                        Receipt
                    </legend>
                </div>
                <div class="modal-body">
                    ...
                    ?>
                    <div align="center" style="color: red;"><h4><strong><?php echo $get_searched['name']; ?></strong>
                        </h4></div>
                    <hr>
                    ...
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tr>
                            ...
                            <th style="color: blue;"><?php echo strtoupper($row['fn']); ?>
                                &nbsp; <?php echo strtoupper($row['ln']); ?></th>
                        </tr>
                        <tr>
