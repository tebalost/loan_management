            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form-horizontal" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <select name="transfer_to" class="form-control" required style="width:100%">
                                        <option value="" selected="selected" required>Select Staff to Transfer to
                                        </option>
                                        <?php
                        ...
                        <hr>
                        <div align="right">
                            <button type="submit" class="btn btn-success btn-flat" name="transfer"><i
                                        class="fa fa-save"></i>&nbsp;Transfer
                            </button>
                            <button type="button" class="btn btn-danger btn-flat" data-dismiss="modal">&nbsp;Close
                            </button>
                        </div>
                            ...
                            try {
                                ...
                                if ($amount < 0) {
                                    ...
                                    if (mysqli_num_rows($slec) == 0) {
                                        ...
                                        $insert2 = mysqli_query($link, "INSERT INTO twallet VALUES('0','$transfer_to','$amount')") or die (mysqli_error($link));
                                        $insert2 = mysqli_query($link, "INSERT INTO mywallet VALUES('0','$tid','$transfer_to','$amount','$desc','$wtype',NOW())") or die (mysqli_error($link));
                                        ...
                                        $insert = mysqli_query($link, "INSERT INTO mywallet VALUES(''0,'$tid','$transfer_to','$amount','$desc','$wtype',NOW())") or die (mysqli_error($link));
